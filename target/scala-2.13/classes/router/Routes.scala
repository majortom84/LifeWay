...
class Routes(
  ...
  // @LINE:9
  TestController_0: controllers.TestController,
  // @LINE:14
  ...
  val prefix: String
   ...
   def this(errorHandler: play.api.http.HttpErrorHandler,
    ...
    // @LINE:14
    Assets_1: controllers.Assets
  ) = this(errorHandler, HomeController_2, TestController_0, Assets_1, "/")

  def withPrefix(addPrefix: String): Routes = {
    val prefix = play.api.routing.Router.concatPrefix(addPrefix, this.prefix)
    router.RoutesPrefix.setPrefix(prefix)
    new Routes(errorHandler, HomeController_2, TestController_0, Assets_1, prefix)
  }
  ...
  def documentation = List(
    ...
    ("""POST""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """test""", """controllers.TestController.index(request:Request)"""),
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """test""", """controllers.TestController.index(request:Request)"""),
  ...
  // @LINE:9
  private[this] lazy val controllers_TestController_index3_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("test")))
  )
  private[this] lazy val controllers_TestController_index3_invoker = createInvoker(
    
    (req:play.mvc.Http.Request) =>
      TestController_0.index(fakeValue[play.mvc.Http.Request]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
  ...
  // @LINE:10
  private[this] lazy val controllers_TestController_index4_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("test")))
  )
  private[this] lazy val controllers_TestController_index4_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:9
    case controllers_TestController_index3_route(params@_) =>
      call { 
        controllers_TestController_index3_invoker.call(
          req => TestController_0.index(req))
      }
  
    // @LINE:10
    case controllers_TestController_index4_route(params@_) =>
      call { 
        controllers_TestController_index4_invoker.call(
          req => TestController_0.index(req))
      }
